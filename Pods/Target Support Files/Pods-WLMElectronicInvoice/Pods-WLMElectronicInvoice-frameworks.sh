...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LRModel/LRModel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LRNet/LRNet.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/LRRouter/LRRouter.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SimpleView/SimpleView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WLBase/WLBase.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WLBaseView/WLBaseView.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WLConst/WLConst.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WLNet/WLNet.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WLPickerView/WLPickerView.framework"
